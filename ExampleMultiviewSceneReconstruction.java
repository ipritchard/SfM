...
public class ExampleMultiviewSceneReconstruction {
	...
	public void process(CameraPinholeRadial intrinsic , List<BufferedImage> colorImages ) {
		...
		double[][] matrix = computeConnections();   // Perhaps not necessary for sequential?
		// this matrix is I x I where I = number of images
	...
	private void initialize( int imageA , int imageB ) {
		...
		normalizeScale(motionWorldToCamera[imageB],tracksA);  // No idea what this does.
	}
